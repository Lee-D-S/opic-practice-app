...
export const questions: Question[] = [
  ...
  {
    id: "im2-park-routine-1",
    level: "IM2",
    type: "routine",
    topic: "parks",
    surveyTags: ["health"],
    sourceSurveyIds: ["parks"],
    prompt: "Tell me about how you usually spend time at parks. What do you do there, and why do you like it?",
    followUpGroupId: "park-routine",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["공원 활동", "루틴", "좋아하는 이유"],
    sampleAnswer:
      "I usually go to a park near my home in the evening. I walk slowly, listen to music, and sometimes sit on a bench. I like it because it helps me clear my mind after a busy day.",
    usefulExpressions: ["I usually go to...", "It helps me clear my mind.", "After a busy day..."],
  },
  {
    id: "im2-camping-experience-1",
    level: "IM2",
    type: "experience",
    topic: "camping",
    surveyTags: ["travel"],
    sourceSurveyIds: ["camping"],
    prompt: "Tell me about a camping trip or outdoor trip you remember. What happened during the trip?",
    followUpGroupId: "camping-memory",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["야외 경험", "시간 순서", "감정"],
    sampleAnswer:
      "Last fall, I went camping with my friends. We cooked dinner outside and talked around a small fire. It was colder than we expected, but the quiet atmosphere made the trip special.",
    usefulExpressions: ["Last fall, I went...", "It was colder than we expected.", "The atmosphere made it special."],
  },
  {
    id: "im2-cooking-routine-1",
    level: "IM2",
    type: "routine",
    topic: "cooking",
    surveyTags: ["food"],
    sourceSurveyIds: ["cooking"],
    prompt: "Tell me about what you usually cook at home. When do you cook, and what do you like about it?",
    followUpGroupId: "cooking-routine",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["요리 루틴", "빈도", "개인적 이유"],
    sampleAnswer:
      "I usually cook simple meals on weekends. I often make fried rice or pasta because they are easy and quick. Cooking helps me save money, and I feel good when the food tastes better than I expected.",
    usefulExpressions: ["I usually cook...", "They are easy and quick.", "I feel good when..."],
  },
  {
    id: "im2-walking-routine-1",
    level: "IM2",
    type: "routine",
    topic: "walking",
    surveyTags: ["exercise", "health"],
    sourceSurveyIds: ["걷기", "walking"],
    prompt: "Tell me about your walking routine. Where do you walk, and how does it help you?",
    followUpGroupId: "walking-routine",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["운동 루틴", "장소", "효과"],
    sampleAnswer:
      "I try to walk for about thirty minutes after dinner. I usually walk around my neighborhood because it is safe and quiet. It helps me digest food and sleep better at night.",
    usefulExpressions: ["I try to walk for...", "I usually walk around...", "It helps me..."],
  },
  {
    id: "im2-staycation-description-1",
    level: "IM2",
    type: "description",
    topic: "staycation",
    surveyTags: ["home"],
    sourceSurveyIds: ["staycation"],
    prompt: "Describe how you usually spend a vacation at home. What makes it relaxing?",
    followUpGroupId: "staycation-basic",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["집에서 보내는 휴가", "활동 묘사", "느낌"],
    sampleAnswer:
      "When I spend a vacation at home, I sleep late, order food, and watch movies. I also clean my room because a clean space makes me feel refreshed. It is simple, but it is relaxing because I do not have to follow a schedule.",
    usefulExpressions: ["When I spend a vacation at home...", "It makes me feel refreshed.", "I do not have to..."],
  },
  {
    id: "im2-concert-experience-1",
    level: "IM2",
    type: "experience",
    topic: "concerts",
    surveyTags: ["music"],
    sourceSurveyIds: ["concerts", "performances"],
    prompt: "Tell me about a concert or performance you enjoyed. Who did you go with, and what did you like most?",
    followUpGroupId: "concert-memory",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["공연 경험", "동행자", "인상 깊은 점"],
    sampleAnswer:
      "I went to a concert with my friend last year. The singer sounded even better live, and everyone sang together during the final song. I liked that moment the most because the whole place felt connected.",
    usefulExpressions: ["I went to a concert with...", "The singer sounded...", "I liked that moment because..."],
  },
  {
    id: "im2-home-improvement-experience-1",
    level: "IM2",
    type: "experience",
    topic: "home improvement",
    surveyTags: ["home"],
    sourceSurveyIds: ["home_improvement"],
    prompt: "Tell me about a time when you improved or reorganized your home. What did you change?",
    followUpGroupId: "home-improvement",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["주거 개선 경험", "변화 내용", "결과"],
    sampleAnswer:
      "Recently, I reorganized my desk area. There were too many cables and books, so the space looked messy. I bought a small shelf and cleaned everything. Now it is easier to study and work there.",
    usefulExpressions: ["Recently, I reorganized...", "The space looked messy.", "Now it is easier to..."],
  },
  {
    id: "im2-domestic-travel-comparison-1",
    level: "IM2",
    type: "comparison",
    topic: "domestic travel",
    surveyTags: ["travel"],
    sourceSurveyIds: ["domestic_travel"],
    prompt: "Compare a recent domestic trip with trips you took when you were younger. What has changed?",
    followUpGroupId: "domestic-travel-comparison",
    difficulty: 2,
    prepTimeSec: 30,
    answerTimeSec: 90,
    evaluationFocus: ["국내 여행", "과거/현재 비교", "변화 이유"],
    sampleAnswer:
      "When I was younger, I mostly followed my family's plan during trips. These days, I choose restaurants and places by myself before I travel. The biggest change is that I care more about local food and quiet places than famous tourist spots.",
    usefulExpressions: ["When I was younger...", "These days, I choose...", "The biggest change is..."],
  },
  {
    id: "ih-camping-problem-1",
    level: "IH",
    type: "problem_solving",
    topic: "camping",
    surveyTags: ["travel"],
    sourceSurveyIds: ["camping"],
    prompt: "Tell me about a problem that could happen during camping or an outdoor trip. How would you handle it?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["야외 문제", "대처 과정", "안전"],
    sampleAnswer:
      "One common problem during camping is sudden bad weather. If it started raining heavily, I would first move important items into the tent or car. Then I would check whether the area was safe. If the weather looked dangerous, I would cancel the plan and leave early. Safety is more important than finishing the trip.",
    usefulExpressions: ["One common problem is...", "I would first...", "Safety is more important than..."],
  },
  {
    id: "ih-cooking-problem-1",
    level: "IH",
    type: "problem_solving",
    topic: "cooking",
    surveyTags: ["food"],
    sourceSurveyIds: ["cooking"],
    prompt: "Tell me about a time when cooking did not go as planned. What happened, and what did you learn?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["요리 문제", "원인", "교훈"],
    sampleAnswer:
      "Once, I tried to cook pasta for my friends, but I added too much salt to the sauce. At first, I was embarrassed because everyone was waiting. I quickly made more plain sauce and mixed it in to reduce the saltiness. It was not perfect, but it was much better. I learned that I should taste food little by little while cooking.",
    usefulExpressions: ["It did not go as planned.", "At first, I was embarrassed.", "I learned that I should..."],
  },
  {
    id: "ih-fitness-comparison-1",
    level: "IH",
    type: "comparison",
    topic: "fitness",
    surveyTags: ["exercise", "health"],
    sourceSurveyIds: ["헬스", "조깅", "요가", "fitness", "jogging"],
    prompt: "Compare exercising alone with exercising with other people. Which works better for you, and why?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["운동 방식 비교", "선호", "이유"],
    sampleAnswer:
      "Exercising alone is convenient because I can choose my own time and pace. However, exercising with other people can be more motivating because someone is waiting for me. For me, exercising alone works better on weekdays, but group exercise is helpful when I lose motivation. So I think the best method depends on the situation.",
    usefulExpressions: ["Exercising alone is convenient because...", "However...", "The best method depends on..."],
  },
  {
    id: "ih-overseas-travel-experience-1",
    level: "IH",
    type: "experience",
    topic: "overseas travel",
    surveyTags: ["travel"],
    sourceSurveyIds: ["overseas_travel"],
    prompt: "Tell me about an overseas trip or a trip to a place with a different culture. What surprised you?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["해외 여행", "문화 차이", "느낀 점"],
    sampleAnswer:
      "When I traveled abroad, I was surprised by how people used public transportation. The system was unfamiliar at first, so I made a few mistakes buying tickets. But after asking a local person for help, I became more comfortable. That experience taught me that small communication can make travel much easier.",
    usefulExpressions: ["I was surprised by...", "The system was unfamiliar at first.", "That experience taught me..."],
  },
  {
    id: "ih-staycation-opinion-1",
    level: "IH",
    type: "unexpected",
    topic: "staycation",
    surveyTags: ["home", "travel"],
    sourceSurveyIds: ["staycation"],
    prompt: "Some people prefer staying home during vacation instead of traveling. What do you think about that choice?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["의견", "장단점", "개인 예시"],
    sampleAnswer:
      "I think staying home during vacation is a reasonable choice, especially when people are tired. Traveling can be exciting, but it also requires planning, money, and energy. A staycation gives people time to rest, clean their space, and enjoy hobbies. Personally, I like mixing both styles because sometimes real rest is more important than visiting a new place.",
    usefulExpressions: ["It is a reasonable choice because...", "Traveling can be exciting, but...", "Personally, I like..."],
  },
  {
    id: "ih-concert-roleplay-1",
    level: "IH",
    type: "roleplay",
    topic: "concerts",
    surveyTags: ["music"],
    sourceSurveyIds: ["concerts", "performances"],
    prompt: "Role-play: You bought concert tickets, but you need to change your plan. Call customer service, explain the situation, and ask about your options.",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["역할극", "상황 설명", "대안 요청"],
    sampleAnswer:
      "Hello, I bought two tickets for this Saturday's concert, but I cannot attend because of a schedule conflict. Could you tell me if I can change the date or transfer the tickets to someone else? If a refund is possible, I would also like to know the deadline and fee.",
    usefulExpressions: ["I cannot attend because of...", "Could you tell me if...", "I would also like to know..."],
  },
  {
    id: "ih-pets-problem-1",
    level: "IH",
    type: "problem_solving",
    topic: "pets",
    surveyTags: ["home"],
    sourceSurveyIds: ["pets"],
    prompt: "Tell me about a problem people may have when taking care of a pet. How should they solve it?",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["반려동물", "문제 해결", "책임감"],
    sampleAnswer:
      "One problem pet owners often face is not having enough time. Pets need regular feeding, exercise, and attention, so a busy schedule can become stressful. I think owners should create a routine and ask family members or pet sitters for help when necessary. Taking care of a pet is not just fun; it is a long-term responsibility.",
    usefulExpressions: ["One problem people often face is...", "I think owners should...", "It is a long-term responsibility."],
  },
  {
    id: "ih-park-unexpected-1",
    level: "IH",
    type: "unexpected",
    topic: "parks",
    surveyTags: ["health"],
    sourceSurveyIds: ["parks"],
    prompt: "Why do you think public parks are important in cities? Give examples from daily life.",
    difficulty: 3,
    prepTimeSec: 30,
    answerTimeSec: 120,
    evaluationFocus: ["공공장소 의견", "예시", "사회적 의미"],
    sampleAnswer:
      "Public parks are important because they give people free space to rest and move around. In big cities, many people live in small apartments and spend a lot of time indoors. Parks give them a place to walk, meet friends, or take children outside. They also make neighborhoods feel more open and healthy.",
    usefulExpressions: ["Public parks are important because...", "They give people a place to...", "They make neighborhoods feel..."],
  },
];

export function getSelectedBackgroundSurveyItemIds(
  backgroundSurvey: BackgroundSurvey,
): string[] {
  return [
    ...backgroundSurvey.leisureIds,
    ...backgroundSurvey.hobbyIds,
    ...backgroundSurvey.sportIds,
    ...backgroundSurvey.travelIds,
  ];
}
...
export function recommendQuestion(
  ...
  selectedSurveyItemIds: string[] = [],
): Question {
  const candidates = questions.filter((question) => question.level === level);
  const detailedMatched = candidates.filter((question) =>
    question.sourceSurveyIds?.some((id) => selectedSurveyItemIds.includes(id)),
  );
  const surveyMatched = candidates.filter((question) =>
    question.surveyTags.some((tag) => selectedTags.includes(tag)),
  );
  const pool =
    detailedMatched.length > 0
      ? detailedMatched
      : surveyMatched.length > 0
        ? surveyMatched
        : candidates;
